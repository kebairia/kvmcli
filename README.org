...
#+html:   <!-- <a href="https://github.com/kebairia/kvmcli"> -->
#+html:   <!--   <img src="images/logo.png" alt="Logo" width="80" height="80"> -->
#+html:   <!-- </a> -->
#+html: 
#+html: <h3 align="center">KVMcli</h3>
#+html: 
#+html:   <p align="center">
#+html:     A Python script for managing virtual machines in a KVM-based environment.
#+html:     <br />
#+html:     <a href="https://github.com/kebairia/kvmcli"><strong>Explore the docs »</strong></a>
#+html:     <br />
#+html:     <br />
#+html:     <a href="https://github.com/kebairia/kvmcli">View Demo</a>
#+html:     ·
#+html:     <a href="https://github.com/kebairia/kvmcli/issues">Report Bug</a>
#+html:     ·
#+html:     <a href="https://github.com/kebairia/kvmcli/issues">Request Feature</a>
#+html:   </p>
#+html: </div>
